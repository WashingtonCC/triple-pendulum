...
while True:
    ...
    # theta2ddt = (R1**2*math.cos(p2.theta)*(p2.theta*dt)**2 - R2**2*math.cos(p2.theta)*(p2.theta*dt)**2-R2*g) * math.sin(p2.theta) / (R1**2*math.cos(p2.theta + R2**2*math.sin(p2.theta)**2)**2)
    # theta3ddt = (R1**2*math.cos(p3.theta)*(p3.theta*dt)**2 - R3**2*math.cos(p3.theta)*(p3.theta*dt)**2-R3*g) * math.sin(p3.theta) / (R1**2*math.cos(p3.theta + R3**2*math.sin(p3.theta)**2)**2)
